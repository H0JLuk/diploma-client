...
export const validationSchema = yup.object().shape({
  ...
  scoreFor3: yup.number().positive().typeError(emptyErrorMessage),
  scoreFor4: yup.number().positive().typeError(emptyErrorMessage),
  scoreFor5: yup.number().positive().typeError(emptyErrorMessage),
